...
export declare class AudioPlayer extends SharedObject<AudioEvents> {
    ...
    /**
     * Replaces the player's native queue with a new ordered list of sources.
     * Android only.
     */
    replaceQueue(sources: AudioSource[], startIndex?: number, startPositionSeconds?: number, autoPlay?: boolean): void;
    /**
     * Seeks to a specific item in the player's native queue.
     * Android only.
     */
    seekToQueueItem(index: number, seekTimeSeconds?: number, autoPlay?: boolean): void;
    /**
